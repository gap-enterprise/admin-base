...
public class AdUser extends TableImpl<AdUserRecord> {
    ...
    public List<UniqueKey<AdUserRecord>> getKeys() {
        return Arrays.<UniqueKey<AdUserRecord>>asList(Keys.AD_USER_PKEY, Keys.AD_USER_LOGIN_KEY);
    }

    @Override
    public List<ForeignKey<AdUserRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AdUserRecord, ?>>asList(Keys.AD_USER__AD_USER_ID_FKEY, Keys.AD_USER__AD_USER_PROFILE_ID_FKEY);
    }
    ...
    public AdPerson adPerson() {
        if (_adPerson == null)
            _adPerson = new AdPerson(this, Keys.AD_USER__AD_USER_ID_FKEY);
    ...
    public AdProfile adProfile() {
        if (_adProfile == null)
            _adProfile = new AdProfile(this, Keys.AD_USER__AD_USER_PROFILE_ID_FKEY);
